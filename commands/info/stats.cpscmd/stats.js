...
module.exports = {
  ...
  async func(msg, {
    ...
    embed.setTitle(`Chip's Stats Report on shard ${bot.shard.id+1}/${clientutil.count}\nCurrent Time: ${currentTime}`)
    embed.setThumbnail(avatar);
    embed.addField("User count:", users, true)
    embed.addField("Server count:", guilds, true)
    embed.addField("Channel count:", channels, true)
    embed.addField("Bot uptime:", uptime, true)
    embed.addField("Memory usage:", memAverage, true)
    embed.addField("CPU usage (%):", cpuAverage, true)
    embed.addField("Chips global stats report across all shards!", "\u200B")
    embed.addField("Total User Count:", userCountG, true)
    embed.addField("Total Server Count:", guildCountG, true)
    embed.addField("Total Channel Count:", channelCountG, true)
    embed.addField("Total Text Channel Count:", textCountG, true)
    embed.addField("Total Voice Channel Count:", voiceCountG, true)
    embed.addField("Average Client Ping:", averagePingG, true)
    embed.addField("Total CPU Usage:", cpuAveG + "%", true)
    embed.addField("Total Memory Usage", memAveG + "MB", true)
    embed.addField("Invite Link:", "[Click Here!](https://discordapp.com/oauth2/authorize?client_id=296855425255473154&scope=bot&permissions=2146958591)")
    embed.addField("Support Server:", "[Click Here!](https://discord.gg/jj5FzF7)")
    embed.addField("Official Website:", "[Click Here!](http://www.chipsbot.tk:8080/)")
    embed.addField("Feeling generous? Donate here to help us pay for hosting and keep our bot updated constantly!", "https://www.paypal.me/wzhouwzhou")
...
async function getGlobalStats() {
  ...
  return resolve([guilds, channels, users, ping, text, voice, cpu])
